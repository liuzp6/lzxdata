package com.lzxuni.modules.activiti.controller;
 ...
 **/
@RestController
@RequestMapping("/admin/LR_WorkFlowModule/WfScheme")
public class ActivitiController extends BaseController {
	...
	public ModelAndView list(){
		ModelAndView mv = new ModelAndView("/admin/LR_WorkFlowModule/WfScheme/index");
		return mv;
	}
