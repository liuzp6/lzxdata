	...
	n.extend(t, {
		...
		excel : {
			init : function () {
				...
				u,
				e;
				o != "" && window.location.href.indexOf(o.F_UrlAddress) != -1 && (u = top.learun.data.get(["excelImportTemplate", f]), !u || (u.entitys ? n.each(u.entitys, function (n, t) {
							i(t.btn)
						}) : (u.entitys = {}, n.each(u.keys, function (n, r) {
								t.getDataForm({
									...
									type : "get",
									success : function (n) {
										var t = top.learun.data.get(["authorizeButton", f, function (t) {
							...
							}))), e = top.learun.data.get(["excelExportTemplate", f]), !e || (console.log(e), n.each(e, function (n, t) {
							var i = top.learun.data.get(["authorizeButton", f, function (n) {
