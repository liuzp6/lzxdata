	...
	<div id="form-body" style="overflow: auto;">
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				<input type="hidden" class="form-control" name="status" id="status" value="商机" >
				<tr>
				...
				<tr>
					...
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="khyjsr" id="khyjsr" value="" >
					</td>
				</tr>
			</table>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/custom/sjkh/insert_o.html",
