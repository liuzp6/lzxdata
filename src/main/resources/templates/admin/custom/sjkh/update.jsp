	...
	<div id="form-body" style="overflow: auto;">
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				...
				<tr>
					<th class="formTitle">潜在需求:<font face="宋体">*</font></th>
					<td class="formValue custmerTd">
				...
				<tr>
					...
					<th class="formTitle">客户预计年收入(万元):</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="khyjsr" id="khyjsr" value="${custom.khyjsr}" >
					</td>
				</tr>
			</table>
		</div>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/custom/sjkh/khmcajax_o.html",
            type: 'POST',
            async: false,
            dataType:"json",
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/custom/sjkh/updateDo.html",
