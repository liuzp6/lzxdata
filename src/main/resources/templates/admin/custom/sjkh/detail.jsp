	...
	<div id="form-body" style="overflow: auto;">
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				...
				<tr>
					<th class="formTitle">潜在需求:</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="syyw" id="syyw" value="${custom.syyw }" readonly=”true”>
					</td>
					<th class="formTitle">挖掘日期:</th>
					<td class="formValue custmerTd" data-type="datetime">
						<input type="text" class="form-control" name="wjrq" id="wjrq" value="<fmt:formatDate  value="${custom.wjrq}" type="both" pattern="yyyy-MM-dd HH:mm" />" readonly=”true”>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="khyjsr" id="khyjsr" value="${custom.khyjsr}" readonly=”true”>
					</td>
				</tr>
				<tr>
