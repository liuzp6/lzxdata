			...
			<table class="form" style="table-layout: auto;">
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="khName" id="khName" value="" >
					</td>
					<th class="formTitle">集团编码:</th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="jtbm" id="jtbm" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="srgjbm" id="srgjbm" value="" >
					</td>
				...
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="four" id="four" value="" >
					</td>
					<th class="formTitle">5月份收入(万元):<font>*</font></th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="five" id="five" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="six" id="six" value="" >
					</td>
					<th class="formTitle">7月份收入(万元):<font>*</font></th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="seven" id="seven" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="eight" id="eight" value="" >
					</td>
					<th class="formTitle">9月份收入(万元):<font>*</font></th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="nine" id="nine" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="eleven" id="eleven" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="twelve" id="twelve" value="" >
					</td>
				</tr>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/custom/customincome/khmcajax_v.html",
            type: 'POST',
            async: false,
            dataType:"json",
            data:{"khName":khName},
            success:function (msg) {
				...
				if(flag == false){
					return false;}
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/custom/customincome/insert_o.html?customId=${customId}",
