	...
	<div id="form-body" style="overflow: auto;">
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				...
				<tr>
					<th class="formTitle">客户名下的协议名称:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="khxymc" id="khxymc" value="${customAgreement.khxymc}">
					</td>
					<th class="formTitle">协议编码:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="xybm" id="xybm" value="${customAgreement.xybm}">
					</td>
				</tr>
				<tr>
					<th class="formTitle">协议起始日期:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control input-datepicker" readonly="readonly"
							   name='startdtime' id='startdtime' value="<fmt:formatDate value="${customAgreement.startdtime}" pattern="YYYY-MM-DD"/>"/>
					</td>
					<th class="formTitle">协议终止日期:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control input-datepicker" readonly="readonly"
							   name='endtime' id='endtime' value="<fmt:formatDate value="${customAgreement.endtime}" pattern="YYYY-MM-DD"/>"/>
					</td>
				</tr>
				<tr>
					<th class="formTitle">备注:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="beizhu" id="beizhu" value="${customAgreement.beizhu}">
					</td>
				</tr>
