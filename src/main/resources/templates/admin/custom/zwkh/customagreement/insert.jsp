			...
			<table class="form" style="table-layout: auto;">
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="khxymc" id="khxymc" value="">
					</td>
					<th class="formTitle">协议编码:<font>*</font></th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="xybm" id="xybm" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						<input type="text" class="form-control input-datepicker" readonly="readonly"
							   name='startdtime' id='startdtime' value=""
				...
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
					<input type="text" class="form-control" name="beizhu" id="beizhu" value="" >
					</td>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/custom/customagreement/khmcajax_v.html",
            type: 'POST',
            async: false,
            dataType:"json",
            data:{"khxymc":khxymc},
        ...
        if(flag == false){
            return false;}
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/custom/customagreement/insert_o.html?customId=${customId}",
