	...
	<div id="form-body" style="overflow: auto;">
		<div style="margin-top: 20px; margin-right: 30px;" >
			<table class="form" style="table-layout: auto;">
				<input  type="hidden" name="bsId" id="bsId" value="${customBusiness.bsId} " />
				<tr contenteditable="false">
					<th class="formTitle">业务名称:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4" readonly="readonly">
						<input type="text" class="form-control" readonly="readonly" name="ywmc" id="ywmc" value="${customBusiness.ywmc}">
					</td>
					<th class="formTitle">资费:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="zf" id="zf" value="${customBusiness.zf}">
					</td>
				</tr>
				<tr>
					<th class="formTitle">数量:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="sl" id="sl" value="${customBusiness.sl}">
					</td>
					<th class="formTitle">备注:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="beizhu" id="beizhu" value="${customBusiness.beizhu}">
					</td>
				</tr>
