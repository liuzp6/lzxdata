...
<script>
    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            url: '${pageContext.request.contextPath}/admin/custom/custombusiness/list_o.html?type=custom&customId=${customId}',
            datatype: "json",
            ...
            colModel: [
                { label: '主键', name: 'bsId', hidden: true },
        ...
        function serach(){
            var url ="${pageContext.request.contextPath}/admin/custom/custombusiness/list_o.html?customId=${customId}"
            var queryJson = {
                ywmc: $("#ywmc").val()
            }
    ...
    function btn_add() {
    	...
    	var url="${pageContext.request.contextPath}/admin/custom/custombusiness/insert_v.html?customId=${customId}";
        dialogOpen({
            id: "add",
            title: "新增公司业务名称",
            url: url,
    ...
    function btn_edit() {
        ...
        if (id) {
            var url='${pageContext.request.contextPath}/admin/custom/custombusiness/update_v.html?type=system&bsId='+id;
            dialogOpen({
                id: "add",
                title: "修改用户",
                url: url,
    ...
    function btn_detail() {
        ...
        if (id) {
            var url='${pageContext.request.contextPath}/admin/custom/custombusiness/detail_v.html?type=system&bsId='+id;
            dialogOpen({
                id: "add",
                title: "修改用户",
                url: url,
    ...
    function btn_delete(ids) {
        ...
        if (ids) {
	        layer.confirm('确认删除么?', {icon: 7, title:'提示'}, function(index){
	    		$.ajax({
	    			url:'${pageContext.request.contextPath}/admin/custom/custombusiness/del_o.html',
	    			data:'bsIds='+ids+"&time="+new Date(),
	    			type:'post',
	    			dataType: "json",
