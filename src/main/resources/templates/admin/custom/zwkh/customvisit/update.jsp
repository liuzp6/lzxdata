			...
			<table class="form" style="table-layout: auto;">
				...
				<tr>
					...
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" name="lxrName" id="lxrName" value="${customVisit.lxrName}">
					</td>
					<th class="formTitle">联系电话:<font>*</font></th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" name="lxdh" id="lxdh" value="${customVisit.lxdh}">
					</td>
				</tr>
				<tr>
					<th class="formTitle">拜访内容:<font>*</font></th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" name="bfnr" id="bfnr" value="${customVisit.bfnr}">
					</td>
					<th class="formTitle">拜访方式:<font>*</font></th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" name="bffs" id="bffs" value="${customVisit.bffs}">
					</td>
				</tr>
				<tr>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/custom/customvisit/updateDo.html",
            param: postData,
            loading: "提交",
            success: function () {
