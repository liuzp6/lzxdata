	...
	<div id="form-body" style="overflow: auto;">
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				<input  type="hidden" name="obsId" id="obsId" value="${customobusiness.obsId} " />
				<tr contenteditable="false">
					...
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4" readonly="readonly">
						<input type="text" class="form-control" readonly="readonly" name="ywmc" id="ywmc" value="${customobusiness.ywmc}">
					</td>
					...
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="zf" id="zf" value="${customobusiness.zf}">
					</td>
				</tr>
				<tr>
					<th class="formTitle">数量:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="sl" id="sl" value="${customobusiness.sl}">
					</td>
					<th class="formTitle">运营商:</th>
					<td class="formValue custmerTd" data-type="datetime" data-value="90be3ec7-02d8-9dda-ef4f-24b8ebf58a0e" colspan="4">
						<input type="text" class="form-control" readonly="readonly" name="yys" id="yys" value="${customobusiness.yys}">
					</td>
				</tr>
