			...
			<table class="form" style="table-layout: auto;">
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="detailName" id="detailName" value="">
					</td>
				...
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="leaderZhiWu" id="leaderZhiWu" value="" >
					</td>
					<th class="formTitle">主要领导联系电话:<font>*</font></th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="lerderPhone" id="lerderPhone" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="firstTel" id="firstTel" value="" >
					</td>
				</tr>
				<tr>
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="secondName" id="secondName" value="" >
					</td>
					<th class="formTitle">第二联系人手机号:</th>
					<td class="formValue custmerTd" colspan="4">

						<input type="text" class="form-control" name="secondTel" id="secondTel" value="" >
					</td>
				</tr>
				...
				<%--<tr>--%>
					...
					<%--<td class="formValue custmerTd" colspan="4">--%>
						...
						<%--<input type="text" class="form-control" name="ywxq" id="ywxq" value="" >--%>
					<%--</td>--%>
					<%--<th class="formTitle">预测收入(万元/年):</th>--%>
					<%--<td class="formValue custmerTd" colspan="4">--%>

						<%--<input type="text" class="form-control" name="sryc" id="sryc" value="" >--%>
					<%--</td>--%>
				<%--</tr>--%>
				<%--<tr>--%>
					...
					<%--<td class="formValue custmerTd" colspan="4">--%>
						...
						<%--<input type="text" class="form-control" name="tzqk" id="tzqk" value="" >--%>
					<%--</td>--%>
				<%--</tr>--%>
					<%--</c:if>--%>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/custom/customDetail/khmcajax_v.html",
            type: 'POST',
            async: false,
            dataType:"json",
            data:{"detailName":detailName},
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/custom/customDetail/insert_o.html?customId=${customId}",
