            ...
            <table>
                <tr>
                    ...
                    <td style="padding-left: 2px;">
                        <input id="detailName" type="text" class="form-control"  style="width: 200px;" />
                    </td>
                    <td>&nbsp;客户地址：</td>
                    <td style="padding-left: 2px;">
                        <input id="address" type="text" class="form-control"  style="width: 200px;" />
                    </td>
...
<script>
    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            url: '${pageContext.request.contextPath}/admin/custom/customDetail/list_o.html?type=custom&customId=${customId}',
            datatype: "json",
            ...
            colModel: [
                { label: '主键', name: 'detailId', hidden: true },
                { label: '状态码', name: 'status', hidden: true },
                { label: '客户名称', name: 'detailName', index: 'detailName', width: 100, align: 'left' },
                { label: '客户地址', name: 'address', index: 'address', width: 100, align: 'left' },
                { label: '固定电话', name: 'tel', index: 'tel', width: 100, align: 'left' },
                { label: '主要领导姓名', name: 'leader', index: 'leader', width: 100, align: 'left' },
                { label: '主要领导职务', name: 'leaderZhiWu', index: 'leaderZhiWu', width: 125, align: 'left' },
                { label: '主要领导联系电话', name: 'lerderPhone', index: 'lerderPhone', width: 110, align: 'left' },
                { label: '第一联系人姓名', name: 'firstName', index: 'firstName', width: 100, align: 'left' },
                { label: '第一联系人手机号', name: 'firstTel', index: 'firstTel', width: 110, align: 'left' },
                { label: '第二联系人姓名', name: 'secondName', index: 'secondName', width: 100, align: 'left' },
                { label: '第二联系人手机号', name: 'secondTel', index: 'secondTel', width: 100, align: 'left' }
            ],
            viewrecords: true,
            rowNum: 15,
            rowList: [15, 30, 100],
        ...
        function serach(){
            var url ="${pageContext.request.contextPath}/admin/custom/customDetail/list_o.html?customId=${customId}"
            var queryJson = {
    ...
    function GetGrid1() {
        ...
        $gridTable.jqGrid({
            ...
            colModel: [
                ...
                { label: '客户地址', name: 'address', index: 'address', width: 100, align: 'left' },
                { label: '固定电话', name: 'tel', index: 'tel', width: 100, align: 'left' },
                { label: '业务需求', name: 'ywxq', index: 'ywxq', width: 100, align: 'left' },
                { label: '收入预测(万元/年)', name: 'sryc', index: 'sryc', width: 100, align: 'left' },
                { label: '拓展情况', name: 'tzqk', index: 'tzqk', width: 100, align: 'left' },
                { label: '主要领导姓名', name: 'leader', index: 'leader', width: 100, align: 'left' },
                { label: '主要领导职务', name: 'leaderZhiWu', index: 'leaderZhiWu', width: 125, align: 'left' },
                { label: '主要领导联系电话', name: 'lerderPhone', index: 'lerderPhone', width: 110, align: 'left' },
                { label: '第一联系人姓名', name: 'firstName', index: 'firstName', width: 100, align: 'left' },
                { label: '第一联系人手机号', name: 'firstTel', index: 'firstTel', width: 100, align: 'left' },
                { label: '第二联系人姓名', name: 'secondName', index: 'secondName', width: 100, align: 'left' },
                { label: '第二联系人手机号', name: 'secondTel', index: 'secondTel', width: 100, align: 'left' }
            ],
            viewrecords: true,
    ...
    function btn_add() {
    	...
    	var url="${pageContext.request.contextPath}/admin/custom/customDetail/insert_v.html?customId=${customId}&status=${status}";
        dialogOpen({
            id: "add",
            title: "新增客户信息",
            url: url,
    ...
    function btn_edit() {
        ...
        if (id) {
            var url='${pageContext.request.contextPath}/admin/custom/customDetail/update_v.html?type=system&detailId='+id+'&status='+${status};
            dialogOpen({
                id: "add",
                title: "修改用户",
                url: url,
    ...
    function btn_detail() {
        ...
        if (id) {
            var url='${pageContext.request.contextPath}/admin/custom/customDetail/detail_v.html?type=system&detailId='+id;
            dialogOpen({
                id: "add",
                title: "修改用户",
                url: url,
    ...
    function btn_delete(ids) {
        ...
        if (ids) {
	        layer.confirm('确认删除么?', {icon: 7, title:'提示'}, function(index){
	    		$.ajax({
	    			url:'${pageContext.request.contextPath}/admin/custom/customDetail/del_o.html',
	    			data:'detailIds='+ids+"&time="+new Date(),
	    			type:'post',
	    			dataType: "json",
