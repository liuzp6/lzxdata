			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<input type="hidden" name="oldParentId" id="oldParentId" value="${menuParent.id }"/>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10" style="float:left;">
                                    ...
                                    <input type="hidden" name="parentId" id="parentId" value="${menuParent.id }"/>
                                    <div>
                                   		<button class="btn btn-primary" type="button" onclick="showMenu();"  style="float:left;">选择</button>
                                    </div>
                                    <div id="parentName" style="margin-left:15px;margin-top:5px;float:left;"><i class="${menuParent.icon }"></i>${menuParent.name }</div>
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10" style="float:left;">
                                    ...
                                    <div>
                                   	...
                                   	<div id="iconName" style="margin-left:80px;margin-top:1px;font-size: 28px;">
                                   	<i class="${menu.icon }"></i>
                                   	</div>
                                </div> 
                            </div>
    ...
    //validClass: "help-block m-b-none"
		...
		$("#myform").validate({
			...
			submitHandler: function(form){  
				...
				$(form).ajaxSubmit({
                    type: "post",
                    url: "${pageContext.request.contextPath}/admin/system/menu/updateDo.html",
                    dataType: "json",
