        ...
        <div style="margin-top: 20px; margin-right: 30px;">
            <table class="form" style="table-layout: auto;">
                ...
                <tr>
                    ...
                    <td class="formValue custmerTd">
                        <input type="text" class="form-control" name="weChat" id="weChat" value="" >
                    </td>
                </tr>
                <tr>
                    <c:if test="${company.parentId!='-1'}">
                        ...
                        <td class="formValue custmerTd" >
                            ...
                            <div id="deptNames" style="margin-left:15px;margin-top:5px;float:left;"></div>
                        </td>
                    </c:if>
                    <c:if test="${company.parentId!='-1'}">
                        <th class="formTitle">岗位</th>
                        <td class="formValue custmerTd" >
                            <input type="hidden" name="postIds" id="postIds" value=""/>
                            <div>
                                <button class="btn btn-primary" type="button" onclick="showPost();"  style="float:left;">选择</button>
                            </div>
                            <div id="postNames" style="margin-left:15px;margin-top:5px;float:left;"></div>
                        </td>
                    </c:if>
                </tr>
                <tr>
                    ...
                    <td class="formValue custmerTd">
                        ...
                        <div id="roleNames" style="margin-left:15px;margin-top:5px;float:left;"></div>
                    </td>
                </tr>
            </table>
        </div>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/system/user/insert_o.html",
