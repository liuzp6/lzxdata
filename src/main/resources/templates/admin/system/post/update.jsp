...
<form id="myform">
    ...
    <input type="hidden" name="isLeaf" id="isLeaf" value="${post.isLeaf}" />
	<input type="hidden" name="companyId" id="companyId" value="${post.companyId}" />
		...
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				...
				<tr>
					...
					<td class="formValue custmerTd" colspan="3">
						<input type="text" class="form-control" name="enCode" id="enCode" value="${post.enCode}" >
					</td>
				</tr>
				<tr>
					<th class="formTitle">所属部门<font face="宋体">*</font></th>
					<td class="formValue custmerTd" >
						<input type="hidden" name="deptId" id="deptId" value="${post.deptId}"/>
						<input type="text" class="form-control" name="deptName" id="deptName" value="${dept.name}" onclick="showDept();" readonly >
					</td>
					<td class="formValue custmerTd" >
				...
				<td class="formValue custmerTd" >
					<input type="hidden" name="parentId" id="parentId" value="${post.parentId}"/>
...
<SCRIPT type="text/javascript">
    ...
    var setting = {
        async: {
            enable: true,
            url:"${pageContext.request.contextPath}/admin/system/post/list_o.html?id=${post.id}&companyId="+$("#companyId").val(),
            autoParam:["id"],
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/system/post/update_o.html",
