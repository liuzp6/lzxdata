			...
			<table class="form" style="table-layout: auto;">
				<tr>
					...
					<td class="formValue custmerTd">
                        ...
                        <input type="hidden" name="companyId" id="companyId" value="${dept.companyId}" />
                        <input type="hidden" name="isLeaf" id="isLeaf" value="${dept.isLeaf}" />
					...
					<td class="formValue custmerTd" colspan="4">
						...
						<input type="text" class="form-control" name="parentName" id="parentName" value="${deptParent.name}" readonly placeholder="为空时代表一级部门">
					</td>
				</tr>
				<tr>
					<th class="formTitle">部门名称<font face="宋体">*</font></th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="name" id="name" value="${dept.name}" >
					</td>
					<th class="formTitle">部门编码</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="enCode" id="enCode" value="${dept.enCode}" >
					</td>
				</tr>
				<tr>
					<th class="formTitle">部门简称</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="shortName" id="shortName" value="${dept.shortName}" >
					</td>
					<th class="formTitle">负责人</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="manager" id="manager" value="${dept.manager}" >
					<%--	<select class="form-control" name="manager" id="manager">
							<option value="">请选择</option>
							<c:forEach items="${deptList }" var="e">
								<option value="${e.manager}" <c:if test="${dept.manager==e.manager}"> selected</c:if>>${e.manager}</option>
							</c:forEach>
						</select>--%>
				...
				<tr>
					...
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="outerPhone" id="outerPhone" value="${dept.outerPhone}" >
					</td>
					<th class="formTitle">分机号</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="innerPhone" id="innerPhone" value="${dept.innerPhone}" >
					</td>
				</tr>
				<tr>
					<th class="formTitle">邮箱</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="email" id="email" value="${dept.email}" >
					</td>
					<th class="formTitle">传真</th>
					<td class="formValue custmerTd">
						<input type="text" class="form-control" name="fax" id="fax" value="${dept.fax}" >
					</td>
				</tr>
				<tr>
					<th class="formTitle">备注</th>
					<td class="formValue custmerTd" colspan="3">
						<textarea name="description" id="description" class="form-control">${dept.description}</textarea>
					</td>
				</tr>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/system/dept/update_o.html",
