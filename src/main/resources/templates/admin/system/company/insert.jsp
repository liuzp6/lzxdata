		...
		<div style="margin-top: 20px; margin-right: 30px;">
			<table class="form" style="table-layout: auto;">
				<tr>
                    ...
                    <td class="formValue custmerTd">
                        <input type="text" class="form-control" name="foundedTime" id="foundedTime" value="" readonly="readonly" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
                    </td>
				</tr>
                <tr>
                    <th class="formTitle">上级公司<font face="宋体">*</font></th>
                    <td class="formValue custmerTd">
                        <input type="hidden" name="parentId" id="parentId" value="${deptParent.id}" />
                        <input type="text" class="form-control" name="parentName" id="parentName" value="${deptParent.name}" >
                    </td>
                ...
                <tr>
                    ...
                    <td class="formValue custmerTd">
                        <input type="text" class="form-control" name="businessScope" id="businessScope" value="" >
                    </td>
                </tr>
                <tr>
...
<script>
    ...
    function AcceptClick(sendStatus) {
        ...
        $.SaveForm({
            url: "${pageContext.request.contextPath}/admin/system/company/insert_o.html",
